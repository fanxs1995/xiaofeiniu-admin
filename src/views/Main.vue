        ...
        <el-menu :default-openeds="defaultOpeneds" :default-active="defaultActive" :unique-opened="true" :router="true">
          ...
          <el-submenu index="table">
            ...
            <el-menu-item-group>
              ...
              <el-menu-item index="/table/add">添加管理</el-menu-item>
          ...
          <el-submenu index="dish">
            ...
            <el-menu-item-group>
              ...
              <el-menu-item index="/dish/add">增加菜品</el-menu-item>
  ...
  export default {
    ...
    beforeCreate() {
      ...
      if(!this.$store.state.adminName){
        this.$router.push("/login");//没有登录 就跳转登录页面
      }
    },
    components:{//当前组建内部使用过的子组件列表
      MainHeader
    }
  }
</script>
